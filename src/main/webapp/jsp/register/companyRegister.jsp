            ...
            <!--主体内容-->
                ...
                <div class="list-int">
                    ...
                    <ul>
                        ...
                        <li><input type="password" class="int-medium" placeholder="请输入您的有效手机号" id="phone"></li>
                        <li class="lable" id="errorPhoneMsg" style="display: none;"><img src="${_base}/theme/slp/images/icon-d.png"><span>请输入正确有效的手机号</span></li>
                    </ul>
                    <ul>
                     ...
                     <ul>
                        <li class="checx-word"><input type="checkbox" class="int-chec">我已阅读并同意<A href="#">《企业用户注册协议》</A></li>
                    ...
                    <ul>
                        <li class="checx-word">
                        	...
                        	<input type="hidden" id="errorPhoneFlag"/>
				         	...
				         	<input type="hidden" id="userType" value="11"/>
                        </li>
                    </ul>
                </div>
                </div>
